  ...
  return (
    ...
    drop-shadow drop-shadow-gray-600/50 dark:drop-shadow-gray-800/50 text-gray-800 dark:text-gray-200"
        >
          ...
          <Link href={`/gates/${gate.id}`} onClick={() => chooseGate(gate)} className="w-full text-center block mt-6 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded ">
            Choose
          </Link>
        </li>
      ))}
